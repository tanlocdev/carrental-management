	<nav class="ts-sidebar" style="background-color:	rgb(176,196,222);">
		<ul class="ts-sidebar-menu">
			...
			<li><a href="gps.php"><i class="fa fa-map fa-lg"></i> <b>Trang chủ</b></a></li>
			<li><a href="dashboard.php"><i class="fa fa-dashboard fa-lg"></i> <b>Thống kê</b></a></li>

			<li><a href="manage-brands.php"><i class="fa fa-files-o fa-lg"></i> <b>Hãng xe</b></a>
				<ul>
			...
			<li class="active"><a href="manage-subscribers.php"><i class="fa fa-table fa-lg"></i> <b class="active">Quản lý ĐK nhận thông tin</b> </a></li>
